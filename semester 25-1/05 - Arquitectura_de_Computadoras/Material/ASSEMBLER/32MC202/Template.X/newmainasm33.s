...
inicio:
    MOV     #2, W0           ; Inicializar el primer número (2)
    MOV     #1, W1           ; Contador de primos encontrados
    MOV     #0, W2           ; Indicador de primo

next_prime:
    MOV     W0, W3           ; Almacenar el número actual en W3
    MOV     #2, W4           ; Inicializar divisor en 2

check_divisor:
    MOV     W0, W5           ; Copiar el número actual
    DIV.S   W5, W4           ; Dividir el número actual por el divisor
    CP      W5, W0           ; Comparar si es divisible
    CPSEQ   W5, #0           ; Saltar si no hay residuo (no primo)

    INC     W4               ; Incrementar el divisor
    CP      W4, W0           ; Comparar divisor con el número actual
    BRA     check_divisor     ; Repetir si divisor < número

found_prime:
    MOV     W3, [W1]         ; Almacenar el primo en memoria
    INC     W1               ; Incrementar el contador de primos
    INC     W0               ; Probar el siguiente número
    BRA     next_prime        ; Continuar con el siguiente número
