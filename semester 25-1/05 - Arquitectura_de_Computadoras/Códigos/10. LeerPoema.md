...
poema:
    .STRING "NOCHI TLAMANTLI TLEN OPANOK 00"
...
CierreCortinas:
    MOV     #tblpage(poema), W0    ; Obtener página de tabla
    MOV     W0, TBLPAG                     ; Cargar TBLPAG con la página
    MOV     #tbloffset(poema), W1  ; Obtener offset inicial
...
loop_cortinas:
    ...
    MOV     W2, PORTB                      ; Enviar el valor a los LEDs
    ;CALL    retardo                    ; Esperar el retardo fijo
    MOV     W3, PORTB                      ; Enviar el valor a los LEDs
    ;CALL    retardo                    ; Esperar el retardo fijo
